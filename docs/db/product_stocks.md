...
| product_stocks_product_id_foreign | FOREIGN KEY | FOREIGN KEY (product_id) REFERENCES products (id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| product_stocks_product_id_foreign | KEY product_stocks_product_id_foreign (product_id) USING BTREE |
| PRIMARY | PRIMARY KEY (id) USING BTREE |

## Relations

![er](product_stocks.svg)
